...
| -------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| VS Marketplace | [![VS Code Marketplace Version](https://vsmarketplacebadges.dev/version/johnrdorazio.vscode-phpcs.svg)](https://marketplace.visualstudio.com/items?itemName=johnrdorazio.vscode-phpcs) | [![VS Code Marketplace Installs](https://vsmarketplacebadges.dev/installs-short/johnrdorazio.vscode-phpcs.svg)](https://marketplace.visualstudio.com/items?itemName=johnrdorazio.vscode-phpcs) | [![VS Code Marketplace Rating](https://vsmarketplacebadges.dev/rating-short/johnrdorazio.vscode-phpcs.svg)](https://marketplace.visualstudio.com/items?itemName=johnrdorazio.vscode-phpcs) |
